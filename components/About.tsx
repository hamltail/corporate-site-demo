    ...
    <section id="about" className="py-[128px]">
      <Container className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)]">
        <div className="w-full md:max-w-[560px]">
          ...
          <p className="text-foreground mt-16 text-[24px] leading-[1.6] font-[500]">
            デザインとテクノロジーで、
            <br />
            より良い体験と未来を作る。
          </p>

          <p className="text-muted mt-16 text-[16px] leading-[1.8]">
            Animal
        ...
        <div className="pt-0 md:pt-[150px]">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <article className="bg-surface flex h-[120px] w-full items-center gap-6 rounded-lg px-6">
              <Image
